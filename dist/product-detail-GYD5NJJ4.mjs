...
var ProductOrganizationSection = ({
  ...
  return /* @__PURE__ */ jsxs5(Container5, { className: "divide-y p-0", children: [
    ...
    /* @__PURE__ */ jsx6(
      ...
      {
        title: t("fields.tags"),
        value: product.tags?.length ? product.tags.map((tag) => /* @__PURE__ */ jsx6(Badge2, { className: "w-fit", size: "2xsmall", asChild: true, children: /* @__PURE__ */ jsx6(Link2, { to: `/products?tag_id=${tag.id}`, children: tag.value }) }, tag.id)) : void 0
      }
    ),
    /* @__PURE__ */ jsx6(
      SectionRow,
      {
        title: t("fields.type"),
        value: product.type ? /* @__PURE__ */ jsx6(Badge2, { size: "2xsmall", className: "w-fit", asChild: true, children: /* @__PURE__ */ jsx6(Link2, { to: `/products?type_id=${product.type_id}`, children: product.type.value }) }) : void 0
      }
    ),
    /* @__PURE__ */ jsx6(
      SectionRow,
      {
        ...
        value: product.collection ? /* @__PURE__ */ jsx6(Badge2, { size: "2xsmall", className: "max-w-[182px]", asChild: true, children: /* @__PURE__ */ jsx6(Link2, { to: `/collections/${product.collection.id}`, children: /* @__PURE__ */ jsx6("span", { className: "truncate", children: product.collection.title }) }) }) : void 0
      }
    ),
    /* @__PURE__ */ jsx6(
      SectionRow,
      {
        ...
        value: product.categories?.length ? product.categories.map((pcat) => /* @__PURE__ */ jsx6(Badge2, { className: "w-fit", size: "2xsmall", asChild: true, children: /* @__PURE__ */ jsx6(Link2, { to: `/categories/${pcat.id}`, children: pcat.name }) }, pcat.id)) : void 0
      }
    ),
