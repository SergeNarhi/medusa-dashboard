...
import {
  ...
  useClaims
} from "./chunk-2RXS75HS.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-TZSOHQ3C.mjs";
import {
...
import {
  useCancelOrderEdit,
  useConfirmOrderEdit
} from "./chunk-BZ724YM6.mjs";
import {
  OrderPaymentSection,
  getPaymentsFromOrder,
  getTotalCaptured
} from "./chunk-ADCRVFU4.mjs";
import {
...
var OrderTimeline = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "flex flex-col gap-y-0.5", children: [
  ...
  return useMemo2(() => {
    ...
    for (const edit of orderChanges.filter((oc) => oc.change_type === "edit")) {
      ...
      items.push({
        ...
        children: isConfirmed ? /* @__PURE__ */ jsx6(OrderEditBody, { edit }) : null
      });
    }
    for (const transfer of orderChanges.filter(
      ...
      if (transfer.requested_at) {
        items.push({
          ...
          children: /* @__PURE__ */ jsx6(TransferOrderRequestBody, { transfer })
        });
      }
...
var OrderActivityItem = ({
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "grid grid-cols-[20px_1fr] items-start gap-2", children: [
    /* @__PURE__ */ jsxs7("div", { className: "flex size-full flex-col items-center gap-y-0.5", children: [
...
var OrderActivityCollapsible = ({
  ...
  return /* @__PURE__ */ jsxs7(Collapsible.Root, { open, onOpenChange: setOpen, children: [
...
var OrderEditBody = ({ edit }) => {
  ...
  return /* @__PURE__ */ jsxs7("div", { children: [
    itemsAdded > 0 && /* @__PURE__ */ jsxs7(Text5, { size: "small", className: "text-ui-fg-subtle", children: [
      t("labels.added"),
      ": ",
      itemsAdded
    ] }),
    itemsRemoved > 0 && /* @__PURE__ */ jsxs7(Text5, { size: "small", className: "text-ui-fg-subtle", children: [
      t("labels.removed"),
      ": ",
      itemsRemoved
    ] })
...
var TransferOrderRequestBody = ({
  ...
  return /* @__PURE__ */ jsxs7("div", { children: [
    /* @__PURE__ */ jsxs7(Text5, { size: "small", className: "text-ui-fg-subtle", children: [
...
var OrderActivitySection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs8(Container5, { className: "flex flex-col gap-y-8 px-6 py-4", children: [
...
var Addresses = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "divide-y", children: [
    ...
    !isSameAddress(data.shipping_address, data.billing_address) ? /* @__PURE__ */ jsx8(AddressPrint, { address: data.billing_address, type: "billing" }) : /* @__PURE__ */ jsxs9("div", { className: "grid grid-cols-2 items-center px-6 py-4", children: [
      /* @__PURE__ */ jsx8(
        Text6,
        {
          size: "small",
...
var OrderCustomerSection = ({ order }) => {
  return /* @__PURE__ */ jsxs10(Container6, { className: "divide-y p-0", children: [
...
var Header = () => {
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between px-6 py-4", children: [
...
import { Fragment as Fragment2, jsx as jsx10, jsxs as jsxs11 } from "react/jsx-runtime";
var OrderFulfillmentSection = ({
  order
}) => {
  const fulfillments = order.fulfillments || [];
  return /* @__PURE__ */ jsxs11("div", { className: "flex flex-col gap-y-3", children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs11("div", { className: "flex items-start gap-x-4", children: [
          ...
          /* @__PURE__ */ jsxs11("div", { children: [
            ...
            item.variant_sku && /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-x-1", children: [
              /* @__PURE__ */ jsx10(Text7, { size: "small", children: item.variant_sku }),
              /* @__PURE__ */ jsx10(Copy3, { content: item.variant_sku, className: "text-ui-fg-muted" })
            ] }),
        ...
        /* @__PURE__ */ jsxs11("div", { className: "grid grid-cols-3 items-center gap-x-4", children: [
          ...
          /* @__PURE__ */ jsx10("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsxs11(Text7, { children: [
...
var UnfulfilledItemDisplay = ({
  ...
  return /* @__PURE__ */ jsxs11(Container7, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs11("div", { className: "flex items-center justify-between px-6 py-4", children: [
...
var Fulfillment = ({
  ...
  return /* @__PURE__ */ jsxs11(Container7, { className: "divide-y p-0", children: [
    ...
    /* @__PURE__ */ jsxs11("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
      ...
      /* @__PURE__ */ jsx10("ul", { children: fulfillment.items.map((f_item) => /* @__PURE__ */ jsx10("li", { children: /* @__PURE__ */ jsxs11(Text7, { size: "small", leading: "compact", children: [
        f_item.quantity,
        "x ",
        f_item.title
      ] }) }, f_item.line_item_id)) })
    ...
    (showShippingButton || showDeliveryButton) && /* @__PURE__ */ jsxs11("div", { className: "bg-ui-bg-subtle flex items-center justify-end gap-x-2 rounded-b-xl px-4 py-4", children: [
...
var OrderGeneralSection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs12(Container8, { className: "flex items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsxs12("div", { children: [
      /* @__PURE__ */ jsxs12("div", { className: "flex items-center gap-x-1", children: [
        /* @__PURE__ */ jsxs12(Heading8, { children: [
          "#",
          order.display_id
        ] }),
    ...
    /* @__PURE__ */ jsxs12("div", { className: "flex items-center gap-x-4", children: [
      /* @__PURE__ */ jsxs12("div", { className: "flex items-center gap-x-1.5", children: [
...
var ButtonMenu = ({
  ...
  return /* @__PURE__ */ jsxs13(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsx12(DropdownMenu.Content, { children: groups.map((group, index) => {
      ...
      return /* @__PURE__ */ jsxs13(DropdownMenu.Group, { children: [
        group.actions.map((action, index2) => {
          ...
          return /* @__PURE__ */ jsx12("div", { children: /* @__PURE__ */ jsx12(
            DropdownMenu.Item,
            {
              ...
              asChild: true,
              disabled: action.disabled,
              children: /* @__PURE__ */ jsxs13(Link4, { to: action.to, onClick: (e) => e.stopPropagation(), children: [
                action.icon,
                /* @__PURE__ */ jsx12("span", { children: action.label })
              ] })
            }
...
function ReturnInfoPopover({ orderReturn }) {
  ...
  return /* @__PURE__ */ jsxs15(Popover2, { open, children: [
    /* @__PURE__ */ jsx14(
      Popover2.Trigger,
      {
        onMouseEnter: handleMouseEnter,
    ...
    /* @__PURE__ */ jsx14(
      Popover2.Content,
      {
        ...
        children: /* @__PURE__ */ jsxs15("div", { className: "", children: [
          ...
          /* @__PURE__ */ jsxs15(Text9, { size: "xsmall", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs17("div", { className: "grid grid-cols-3 items-center gap-x-4", children: [
            ...
            /* @__PURE__ */ jsxs17("div", { className: "flex items-center gap-x-2", children: [
              /* @__PURE__ */ jsx16("div", { className: "w-fit min-w-[27px]", children: /* @__PURE__ */ jsxs17(Text10, { size: "small", children: [
...
var Cost = ({
  ...
  /* @__PURE__ */ jsxs17(Text10, { size: "small", leading: "compact", children: [
    label,
    " ",
    tooltip
  ] }),
  ...
  return item && /* @__PURE__ */ jsxs17(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs17(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: [
    ...
    /* @__PURE__ */ jsxs17(
      "div",
      {
        ...
        children: [
          ...
          orderReturn && isRequested && /* @__PURE__ */ jsxs17(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: [
