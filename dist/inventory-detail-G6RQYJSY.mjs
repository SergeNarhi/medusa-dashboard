...
var CreatedAtCell = ({ date }) => {
  ...
  return /* @__PURE__ */ jsx7("div", { className: "flex h-full w-full items-center overflow-hidden", children: /* @__PURE__ */ jsx7(
    ...
    {
      className: "z-10",
      content: /* @__PURE__ */ jsx7("span", { className: "text-pretty", children: `${format(
        value,
        timestampFormat
      )}` }),
      children: /* @__PURE__ */ jsx7("span", { className: "truncate", children: format(value, "dd MMM yyyy") })
    }
  ) });
};
