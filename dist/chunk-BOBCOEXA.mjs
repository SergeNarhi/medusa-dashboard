...
function useSize(element) {
  const [size3, setSize] = React12.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ jsx8(Root2, { ...popperScope, children: /* @__PURE__ */ jsx8(
    PopoverProvider,
    {
...
var PopoverAnchor = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx8(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.hasCustomAnchor ? trigger : /* @__PURE__ */ jsx8(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx8(PortalProvider, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsx8(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx8(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx8(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ jsx8(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsx8(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx8(Combination_default, { as: Slot, allowPinchZoom: true, children: /* @__PURE__ */ jsx8(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope(__scopePopover);
    return /* @__PURE__ */ jsx8(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
